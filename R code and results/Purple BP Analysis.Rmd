...
```{r, echo=TRUE}
test1<-read.csv(file="/Users/guoxinyu/Documents/USC/Final Thesis/stage 2/testP BP.csv",header = TRUE,sep =",")
...
#pngRes <- getAmigoTree(goIDs=goIDs, pvalues=pvalues, pcolors = c("white","tomato"),psplit = c(1,0.25,0.1,0.05,0.001), filename="/Purple BP Amigo", picType="png", saveResult=TRUE)

#pvalues1<-rep(0.0001, length(xlsxBP$ID))
#pngRes1<- getAmigoTree(goIDs=xlsxBP$ID, pvalues=pvalues1, pcolors = c("white","tomato"),psplit = c(1,0.25,0.1,0.05,0.001), filename="/Purple BP author", picType="png", saveResult=TRUE)
```
